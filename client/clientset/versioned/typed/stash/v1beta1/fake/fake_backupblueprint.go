...
var backupblueprintsResource = v1beta1.SchemeGroupVersion.WithResource("backupblueprints")

var backupblueprintsKind = v1beta1.SchemeGroupVersion.WithKind("BackupBlueprint")
...
func (c *FakeBackupBlueprints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.BackupBlueprint, err error) {
	...
	return obj.(*v1beta1.BackupBlueprint), err
}
...
func (c *FakeBackupBlueprints) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.BackupBlueprintList, err error) {
	...
	list := &v1beta1.BackupBlueprintList{ListMeta: obj.(*v1beta1.BackupBlueprintList).ListMeta}
	for _, item := range obj.(*v1beta1.BackupBlueprintList).Items {
