...
var tasksResource = schema.GroupVersionResource{Group: "stash.appscode.com", Version: "v1beta1", Resource: "tasks"}

var tasksKind = schema.GroupVersionKind{Group: "stash.appscode.com", Version: "v1beta1", Kind: "Task"}
...
func (c *FakeTasks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Task, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(tasksResource, name), &v1beta1.Task{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeTasks) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.TaskList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(tasksResource, tasksKind, opts), &v1beta1.TaskList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeTasks) Create(ctx context.Context, task *v1beta1.Task, opts v1.CreateOptions) (result *v1beta1.Task, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(tasksResource, task), &v1beta1.Task{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Task), err
...
func (c *FakeTasks) Update(ctx context.Context, task *v1beta1.Task, opts v1.UpdateOptions) (result *v1beta1.Task, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(tasksResource, task), &v1beta1.Task{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Task), err
...
func (c *FakeTasks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(tasksResource, name), &v1beta1.Task{})
	return err
}
...
func (c *FakeTasks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Task, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(tasksResource, name, pt, data, subresources...), &v1beta1.Task{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Task), err
