...
// RestoreBatchesGetter has a method to return a RestoreBatchInterface.
...
// restoreBatches implements RestoreBatchInterface
type restoreBatches struct {
	client rest.Interface
	ns     string
}

// newRestoreBatches returns a RestoreBatches
func newRestoreBatches(c *StashV1beta1Client, namespace string) *restoreBatches {
...
func (c *restoreBatches) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.RestoreBatch, err error) {
	result = &v1beta1.RestoreBatch{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("restorebatches").
		Name(name).
...
func (c *restoreBatches) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.RestoreBatchList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.RestoreBatchList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("restorebatches").
...
func (c *restoreBatches) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *restoreBatches) Create(ctx context.Context, restoreBatch *v1beta1.RestoreBatch, opts v1.CreateOptions) (result *v1beta1.RestoreBatch, err error) {
	result = &v1beta1.RestoreBatch{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("restorebatches").
...
func (c *restoreBatches) Update(ctx context.Context, restoreBatch *v1beta1.RestoreBatch, opts v1.UpdateOptions) (result *v1beta1.RestoreBatch, err error) {
	result = &v1beta1.RestoreBatch{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("restorebatches").
		Name(restoreBatch.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(restoreBatch).
		Do(ctx).
		Into(result)
...
func (c *restoreBatches) UpdateStatus(ctx context.Context, restoreBatch *v1beta1.RestoreBatch, opts v1.UpdateOptions) (result *v1beta1.RestoreBatch, err error) {
	result = &v1beta1.RestoreBatch{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("restorebatches").
...
func (c *restoreBatches) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *restoreBatches) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *restoreBatches) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.RestoreBatch, err error) {
	result = &v1beta1.RestoreBatch{}
