...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackupOverviewRequest) DeepCopyInto(out *BackupOverviewRequest) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupOverviewRequest.
func (in *BackupOverviewRequest) DeepCopy() *BackupOverviewRequest {
	if in == nil {
		return nil
	}
	out := new(BackupOverviewRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackupOverviewResponse) DeepCopyInto(out *BackupOverviewResponse) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupOverviewResponse.
func (in *BackupOverviewResponse) DeepCopy() *BackupOverviewResponse {
	if in == nil {
		return nil
	}
	out := new(BackupOverviewResponse)
	in.DeepCopyInto(out)
	return out
}
